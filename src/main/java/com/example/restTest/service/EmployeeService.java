...
import com.example.restTest.dao.EmployeeDao;
import com.example.restTest.entity.Employee;
import com.example.restTest.exception.EmployeeNotFoundException;
...
public class EmployeeService {
	...
	public List<Employee> getEmployeeByName(String name){
		Optional option=employeeDao.findByName(name);
		if(option.isPresent()){
			return (List<Employee>) option.get();
		}else
			throw new EmployeeNotFoundException("id is not found");
	}
